...
//int main()
//{
//    string xmlPath = "E:\\opencv3\\opencv\\build\\etc\\haarcascades\\haarcascade_frontalface_alt.xml";
//    CascadeClassifier ccf;   //创建分类器对象
//    Mat img = imread("E:\\FaceDetection_cv3\\FaceDetection\\data\\sse-gather.jpg");
